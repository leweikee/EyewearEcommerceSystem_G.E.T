...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('resources/css/checkout.css')); ?>">
    <script src="<?php echo e(asset('/resources/js/checkout.js')); ?>"></script>
</head>
<body>
    ...
    <div class="container">
        ...
        <div class="container mb-3">
            ...
            <div class="row d-flex align-items-center px-5 pb-2" style="background-color: #F9F9F6;">
                <div class="col-md-4 d-flex fw-bold align-items-center">
                    <div class="col-auto">
                        <span id="recipientName"><?php echo e($deliveryAdd->recipientName); ?> | </span>
                    </div>
                    <div class="col ms-2 align-items-center d-flex">
                        <div>
                            <span id="recipientPhoneNum">(+60) <?php echo e($deliveryAdd->recipientPhoneNum); ?></span>
                        </div>
                    </div>
                    <div class="col d-flex align-items-center" style="margin-left: auto;">
                        <div class="dropdown d-flex" style="display: inline-block; background:none; width: 20px; height: 20px; border: none; box-shadow: none">
                            ...
                            <ul class="dropdown-menu py-0" id="updateAddressDropdownMenu" aria-labelledby="updateAddressDropdown">
                                ...
                                <?php $__currentLoopData = $userAdd; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $address): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <a class="dropdown-item px-4 justify-content-start" href="#">
                                        <input class="form-check-input" type="radio" name="selectedAddress" id="address_<?php echo e($address->addressID); ?>" data-address="<?php echo e(json_encode($address)); ?>" <?php echo e($address->is_default ? 'checked' : ''); ?> autocomplete="address">
                                        <label for="address_<?php echo e($address->addressID); ?>" class="form-check-ratio ps-3" style="text-align: left;">
                                            <div><?php echo e($address->recipientName); ?> | (+60) <?php echo e($address->recipientPhoneNum); ?></div>
                                            <div><?php echo e($address->address); ?>, <?php echo e($address->postcode); ?>, <?php echo e($address->city); ?>, <?php echo e($address->state); ?>.</div>
                                        </label>
                                    </a>
                                </li>
            ...
            <div class="row d-flex align-items-center px-5 pb-4" style="background-color: #F9F9F6;" id="selectedAddressInfo">
                <div class="col">
                    <div class="col" id="deliveryAddressContent">
                        <span id="deliveryAddressText"><?php echo e($deliveryAdd->address); ?>, <?php echo e($deliveryAdd->postcode); ?>, <?php echo e($deliveryAdd->city); ?>, <?php echo e($deliveryAdd->state); ?>.</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row d-flex text-center mx-0 p-3 mb-3" style="background-color: #F9F9F6; color: #000;">
            ...
            <?php $__currentLoopData = $checkoutItem; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $selectItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="row d-flex align-items-center mx-0 mb-3">
            ...
            <div class="col-4 d-flex flex-column justify-content-end p-3 px-4 mb-3" style="background-color: #F9F9F6; color: #000;">
                ...
                <div class="row mt-2 px-3">
                    ...
                    <div class="col-md-6">
                        <div class="col text-end"><span id="merchandiseSubtotal">RM <?php echo e(number_format($totalPrice, 2)); ?></span></div>
                        <div class="col text-end mt-2"><span id="shippingFee">RM <?php echo e(number_format($shippingFee, 2)); ?></span></div>
                        <div class="col text-end mt-2 fw-bold fs-5"><span id="totalPayment" style="color: red;">RM <?php echo e(number_format($totalPayment, 2)); ?></span></div>
                        <!-- hidden input to pass price and shipping fee -->
                        <input type="hidden" id="totalPayment" name="totalPayment" value="<?php echo e($totalPayment); ?>">
                        <input type="hidden" id="shippingFee" name="shippingFee" value="<?php echo e($shippingFee); ?>">
                        <input type="hidden" name="checkoutItem" value="<?php echo e(json_encode($checkoutItem)); ?>">
                        <input type="hidden" name="selectedAddressID" id="selectedAddressID" value="" data-address-id="<?= $deliveryAdd->addressID ?>">
                        <input type="hidden" name="power[]" value="<?php echo e($selectItem->powers); ?>" class="form-control">
                    </div>
                </div>
