...
<body>
            ...
            <div class="col-md-6">
                <div class="form pt-3 pb-4 mt-3">
                    ...
                    <div id="error-alert" class="alert alert-danger pt-2 pb-0 text-left">
                        ...
                        <span class="fs-6">- <?php echo e($error); ?></span><br>
    ...
    <!-- <script>
    let passworderrorMessage = "<?php echo e($errors->first('password')); ?>";
    if (passworderrorMessage !== "") {
        alert(passworderrorMessage);
    }
    
    let confirmationerrorMessage = "<?php echo e($errors->first('password_confirmation')); ?>";
    if (confirmationerrorMessage !== "") {
        alert(confirmationerrorMessage);
    }

    let errorMessage = "<?php echo e($errors->first('name')); ?>";
    if (errorMessage !== "") {
        alert(errorMessage);
    }
...
</html><?php /**PATH C:\laragon\www\powerdabest-G.E.T\resources\views/register.blade.php ENDPATH**/ ?>