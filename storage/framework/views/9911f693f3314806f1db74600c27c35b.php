...
<head>
        ...
        <title>G.E.T. Register_Success Page</title>
...
<body>
        ...
        <div class="form ;mx-auto p-2 ; width: 200px;'">
            <div>
            ...
            <div >
                 <br>
                 <br>
                 <p align="center">You have successfully registered. Please <a href="/login">click here</a> to login.</p>
            </div>
    
    </div>
</body>
</html>
<?php /**PATH C:\laragon\www\powerdabest-G.E.T\resources\views/register_success.blade.php ENDPATH**/ ?>