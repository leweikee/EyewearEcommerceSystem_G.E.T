...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <body>
        ...
        <img src="<?php echo e(asset('resources/images/p5.png')); ?>" class="img-fluid" alt="About Us" style="Width:100%; height:75vh" >
        <div class="mx-auto" style="width: 75%">
            ...
            <div class="mx-auto my-5" style="width: 80%">
                <div class="row align-items-center">
                    <div class="col-md-4">
                        <img src="<?php echo e(asset('resources/images/p6.png')); ?>" class="img-thumbnail" alt="Our Story" style="width: auto; height: auto;">
                    </div>
            ...
            <div class="mx-auto my-5 text-center align-items-center" style="width: 100%">
                <img class="my-3" src="<?php echo e(asset('resources/images/p7.png')); ?>" class="rounded mx-auto d-block" alt="vision&mission" style="width: 50%; height: auto">
            ...
            <div class="ms-auto my-5 bg-white bg-opacity-25" style="width: 100%" >
                <div class="row m-5 me-0">
                    ...
                    <div class="col-4 text-left m-0 p-0 justify-content-center">
                        <img src="<?php echo e(asset('resources/images/p8.png')); ?>" class="rounded mx-auto d-block" alt="customer advantage" style="width: 100%; height: 100%">
                    </div>
                </div>   
            </div>
            ...
            <div class="my-5 bg-white bg-opacity-25" style="width: 100%" >
                <div class="row m-5 ms-0">
                    <div class="col-4 text-left m-0 p-0 justify-content-center">
                        <img src="<?php echo e(asset('resources/images/p9.png')); ?>" class="rounded mx-auto d-block" alt="customer advantage" style="width: 100%; height: 100%">
                    </div>
...
</html><?php /**PATH C:\laragon\www\powerdabest-G.E.T\resources\views/aboutUs.blade.php ENDPATH**/ ?>