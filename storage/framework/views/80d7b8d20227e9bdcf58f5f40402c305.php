    ...
    <body>
        ...
        <div class="row mt-5">
            <div class="col-md-3">
                <div class="card card-body d-flex text-white mb-3 text-center py-5" style="background-color: #362f27; opacity: 0.6;" 
                    ...
                    <a href="<?php echo e(route('admin.manageOrders')); ?>" class="text-white align-items-center justify-content-center" style="text-decoration: none;">
        ...
        <!-- <div class="row"> -->
             <div class="col-md-3">
                <div class="card card-body d-flex text-white mb-3 text-center py-5" style="background-color: #362f27; opacity: 0.6;" 
                    onmouseover="this.style.opacity=1;" onmouseout="this.style.opacity=0.6;">
                    <a href="<?php echo e(route('admin.manageProducts')); ?>" class="text-white align-items-center justify-content-center" style="text-decoration: none;">
            ...
            <div class="col-md-3">
                <div class="card card-body d-flex text-white mb-3 text-center py-5" style="background-color: #362f27; opacity: 0.6;" 
                    onmouseover="this.style.opacity=1;" onmouseout="this.style.opacity=0.6;">
                    <a href="<?php echo e(route('admin.manageBrands')); ?>" class="text-white align-items-center justify-content-center" style="text-decoration: none;">
