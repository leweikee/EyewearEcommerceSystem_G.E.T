        ...
        <div class="container mb-3 g-4">
            ...
            <nav>
                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                        <th colspan="3" scope="col" class="w-50 ps-5"><?php echo e($x->deliveryAddress->recipientName); ?></th>
                        <th colspan="3" scope="col" class="w-50 text-end pr-5 pe-3">OrderID: <?php echo e($x->orderID); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr class="mb-3 rounded shadow" style="background-color: #f9f9f6">
                            ...
                            <tr>
                                <td scope="col" colspan="5" class="ps-5"><span class="h5">Total Amount: </span><span class="text-danger h5 ps-2">RM <?php echo e(number_format($x->total_price, 2)); ?></span>
                                <a href="<?php echo e(route('admin.showOrderDetails',$x->orderID)); ?>" class="btn btn-primary btn-sm px-4 py-1 me-4 active float-sm-end" role="button" aria-pressed="true">View Details</a></td>
                            </tr>
                    ...
                    <tbody>
                        ...
                        <tr class="mb-3 rounded shadow" style="background-color: #f9f9f6">
                            ...
                            <tr>
                                ...
                                <a href="<?php echo e(route('admin.showOrderDetails',$x->orderID)); ?>" class="btn btn-primary btn-sm px-4 py-1 me-4 active m-2" role="button" aria-pressed="true">View Details</a>
                                <a class="btn btn-warning btn-sm px-4 py-1 me-4 active m-2" role="button" onclick="ship(<?php echo e($x->orderID); ?>)" aria-pressed="true">Order Shipped</a></td></span>
                            </tr> 
                    ...
                    <tbody>
                        ...
                        <tr class="mb-3 rounded shadow" style="background-color: #f9f9f6">
                            ...
                            <tr class="align-items-center">
                                <td scope="col" colspan="5" class="ps-5"><span class="h5">Total Amount: </span><span class="text-danger h5 ps-2">RM <?php echo e(number_format($x->total_price, 2)); ?></span>
                                <span class="float-sm-end">
                                <a href="<?php echo e(route('admin.showOrderDetails',$x->orderID)); ?>" class="btn btn-primary btn-sm px-4 py-1 me-4m active m-2" role="button" aria-pressed="true">View Details</a>
                            </tr> 
